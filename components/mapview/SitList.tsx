...
const SitList = ({ map, onIndex, onToggle, changeSit }): JSX.Element => {
  ...
  const SitData: sitDataType[] = [
    { sit: 'Rescue', time: '11.19 09:08:00' , datail: '1St fire response', place: '18-13, Yongdu-daero 15-gil, Jecheon-si, Chungcheongbuk-do, Republic of Korea', latlon: [128.1993585, 37.1403084] },
    { sit: 'Situational message', time: '11.18 14:48:00' , datail: '[Rescue] Emergency dispatch order for a water accident', place: 'Seongsu dong ,Seongdong-gu, Seoul, Republic of Korea' },
